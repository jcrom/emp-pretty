...
(function (root, name, factory) {
  ...
  var EOF = 1, StringLiteral = 2, Keyword = 4, Identifier = 8
    ...
    , NilLiteral = 128, VarargLiteral = 256, SLT2Literal = 512;

  exports.tokenTypes = { EOF: EOF, StringLiteral: StringLiteral
    , Keyword: Keyword, Identifier: Identifier, NumericLiteral: NumericLiteral
    , Punctuator: Punctuator, BooleanLiteral: BooleanLiteral
    , NilLiteral: NilLiteral, VarargLiteral: VarargLiteral
    , SLT2Literal:SLT2Literal
  };
  ...
  var errors = exports.errors = {
    ...
    , unfinishedLongSlt2: 'unfinished long slt2 (starting at line %1) near \'%2\''
  };
  ...
  var ast = exports.ast = {
    ...
    , slt2Statement: function(body, raw) {
    return {
        type: 'SLT2Literal'
      , body: body
      , raw: raw
  ...
  function unexpected(found) {
    ...
    if ('undefined' !== typeof found.type) {
      ...
      switch (found.type) {
        ...
        case SLT2Literal:     type = 'slt2';        break;
  ...
  function lex() {
    ...
    switch (charCode) {
      ...
      case 35: // [
        // Check for a multiline string, they begin with [= or [[
        if (123 === next ) return scanSLT2Literal();
        return scanPunctuator('#');
      ...
      case 93: case 40: case 41: case 59:  case 45:
      case 43: // * ^ % , { } ] ( ) ; # - +
  ...
  function readLongSlt2() {
    ...
    // Exit, this is not a long slt2 afterall.
    ...
    raise({}, errors.unfinishedLongSlt2,
          firstLine, '<eof>');
  }
...
// jcparseBlock
  function parseBlock(terminator) {
    ...
    while (!isBlockFollow(token)) {
      ...
      if (SLT2Literal === token.type) {
        markLocation()
        let tmp_raw = input.slice(token.range[0], token.range[1]),
            tmp_val = token.value;
        next();
        block.push(finishNode(ast.slt2Statement(tmp_val, tmp_raw)));
  ...
  function parsePrimaryExpression() {
    var literals = StringLiteral | NumericLiteral | BooleanLiteral | NilLiteral | VarargLiteral | SLT2Literal
      , value = token.value
      , type = token.type
      , marker;
